...
'''
if(os.path.isfile('request_token') != True):
    print "Need an authentication bearer token file called request_token"
    print 'The content of the file will be "Authorization":"Bearer <token>" Don\'t forget the "\'s'
    sys.exit(0)

with open("request_token") as f:
